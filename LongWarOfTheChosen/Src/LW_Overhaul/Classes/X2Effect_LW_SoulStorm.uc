class X2Effect_LW_SoulStorm extends X2Effect_ApplyDirectionalWorldDamage;
...
simulated function ApplyDirectionalDamageToTarget(XComGameState_Unit SourceUnit, XComGameState_Unit TargetUnit, XComGameState NewGameState)
{
	...
	EnvironmentalDamageAmount = class'X2Ability_LW_PsiOverhaul'.default.SOULSTORM_ENVIRONMENAL_DAMAGE;
	...
	bHitTargetTile = class'X2Ability_LW_PsiOverhaul'.default.SOULSTORM_SPARES_CEILINGS;
	...
	if( AbilityContext != none )
	{
		...
		DamageEvent.DamageRadius = class'X2Ability_LW_PsiOverhaul'.default.SOULSTORM_ENVIRONMENAL_RADIUS;	
