...
var config int LWPRIMARYPISTOL_CONVENTIONAL_AIM;
var config int LWPRIMARYPISTOL_CONVENTIONAL_CRITCHANCE;
var config int LWPRIMARYPISTOL_CONVENTIONAL_ICLIPSIZE;
var config int LWPRIMARYPISTOL_CONVENTIONAL_ISOUNDRANGE;
var config int LWPRIMARYPISTOL_CONVENTIONAL_IENVIRONMENTDAMAGE;
