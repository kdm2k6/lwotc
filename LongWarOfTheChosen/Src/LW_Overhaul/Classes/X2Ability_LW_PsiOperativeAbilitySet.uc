...
static function X2DataTemplate Create_NullWard()
{
	...
	ShieldedEffect.BuildPersistentEffect (9, false, true, false, eGameRule_PlayerTurnBegin);
...
static function X2AbilityTemplate Create_SoulStorm()
{
	...
	DamageEffect.AddTargetEffect(WeaponDamageEffect);

	Template.AddMultiTargetEffect(new class'X2Effect_LW_SoulStorm');	//	environmental destruction
	...
	Template.ActionFireClass = class'X2Action_LW_PsiPinion';
