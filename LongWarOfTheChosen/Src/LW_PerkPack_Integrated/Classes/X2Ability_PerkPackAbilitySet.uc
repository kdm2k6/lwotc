...
static function X2AbilityTemplate AddHitandRunAbility()
{
	...
	HitandRunEffect.FullAction = default.HNR_FULL_ACTION;
...
static function X2AbilityTemplate AddExecutionerAbility()
{
	...
	AimandCritModifiers.AimBonus = default.EXECUTIONER_AIM_BONUS;
	AimandCritModifiers.CritBonus = default.EXECUTIONER_CRIT_BONUS;
	AimandCritModifiers.HealthPerc = default.EXECUTIONER_HEALTH_PERC;
